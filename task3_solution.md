# Task 3 solution walkthrough (facilitator only)
...
A working reference solver is in `../task3_reference_solver.py`
...
If you also keep task 1, plan for a 3-hour slot.

## Pre-flight you must do

Run `task3_reference_solver.py` yourself with `gpt-5.4-mini`'s
